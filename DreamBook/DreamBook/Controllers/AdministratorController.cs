...
namespace DreamBook.Controllers
{
    public class AdministratorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Email,Sifra")] Administrator administrator)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Email,Sifra")] Administrator administrator)
        {
